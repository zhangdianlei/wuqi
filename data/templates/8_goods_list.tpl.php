...
<ul>
    ...
    <div class="inner" style="display:none;">
        <ul>
        <?php $hotcities = get_hot_cities(); ?>        <?php if(is_array($hotcities)){foreach($hotcities as $k => $mymps) { ?>        <a href="index.php?mod=goods&catid=<?=$catid?>&cityid=<?=$mymps['cityid']?>"><?=$mymps['cityname']?></a>
        <?php }} ?> 
        </ul>
    </div>
    <?php } ?>
